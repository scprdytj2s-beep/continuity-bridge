const TRANSLATIONS = {
  nl: {
    ...
    faq1_a: 'Dit is een standaard macOS-beveiliging voor apps buiten de App Store. Je kunt dit veilig negeren — Continuity Bridge bevat geen malware. We werken aan een Apple Developer-certificaat zodat deze melding verdwijnt.',
    faq1_s1: '<strong style="color:var(--accent2)">Stap 1</strong> — Je ziet dit venster als je de app voor het eerst opent. Klik op <strong>Klaar</strong>.',
    faq1_s2: '<strong style="color:var(--accent2)">Stap 2</strong> — Ga naar <strong>Systeeminstellingen → Privacy en beveiliging</strong> en klik op <strong>Toch openen</strong>.',
    faq1_s3: '<strong style="color:var(--accent2)">Stap 3</strong> — Bevestig door opnieuw op <strong>Toch openen</strong> te klikken.',
  ...
  en: {
    ...
    faq1_a: 'This is standard macOS security for apps outside the App Store. You can safely ignore this — Continuity Bridge contains no malware. We are working on an Apple Developer certificate to make this warning disappear.',
    faq1_s1: '<strong style="color:var(--accent2)">Step 1</strong> — You see this window when you open the app for the first time. Click <strong>Done</strong>.',
    faq1_s2: '<strong style="color:var(--accent2)">Step 2</strong> — Go to <strong>System Settings → Privacy & Security</strong> and click <strong>Open Anyway</strong>.',
    faq1_s3: '<strong style="color:var(--accent2)">Step 3</strong> — Confirm by clicking <strong>Open Anyway</strong> again.',
  ...
  de: {
    ...
    faq1_a: 'Das ist eine standardmäßige macOS-Sicherheitsfunktion für Apps außerhalb des App Stores. Du kannst dies sicher ignorieren — Continuity Bridge enthält keine Malware. Wir arbeiten an einem Apple-Developer-Zertifikat, damit diese Meldung verschwindet.',
    faq1_s1: '<strong style="color:var(--accent2)">Schritt 1</strong> — Dieses Fenster erscheint, wenn du die App zum ersten Mal öffnest. Klicke auf <strong>Fertig</strong>.',
    faq1_s2: '<strong style="color:var(--accent2)">Schritt 2</strong> — Gehe zu <strong>Systemeinstellungen → Datenschutz & Sicherheit</strong> und klicke auf <strong>Trotzdem öffnen</strong>.',
    faq1_s3: '<strong style="color:var(--accent2)">Schritt 3</strong> — Bestätige, indem du erneut auf <strong>Trotzdem öffnen</strong> klickst.',
