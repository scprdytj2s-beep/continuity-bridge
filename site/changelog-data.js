    ...
    groups: [
      {
        ...
        items: [
          {
            nl: 'Je kunt nu ook een Avid <strong>.avb-bin</strong>-bestand direct inslepen, naast de gebruikelijke ALE-export',
            en: 'You can now also drag in an Avid <strong>.avb bin</strong> file directly, alongside the usual ALE export',
            de: 'Du kannst jetzt auch eine Avid-<strong>.avb-Bin</strong>-Datei direkt hineinziehen, zusätzlich zum gewohnten ALE-Export',
          },
          {
            nl: 'Twijfelt het programma over een take (bijv. een onduidelijke scene of slate)? Dan zie je nu een duidelijk <strong>keuzevenster</strong>, met een knop om meteen de juiste pagina in je PDF te openen',
            en: 'If the app is unsure about a take (e.g. an unclear scene or slate), you now get a clear <strong>choice window</strong>, with a button to open the right page in your PDF straight away',
            de: 'Ist sich das Programm bei einem Take nicht sicher (z. B. unklare Szene oder Slate), erscheint jetzt ein klares <strong>Auswahlfenster</strong> mit einer Schaltfläche, um sofort die richtige PDF-Seite zu öffnen',
          },
          {
            nl: '<strong>AFG</strong> kan nu ook in een eigen kolom worden gezet, net als PU al kon',
            en: '<strong>AFG</strong> can now also be written to its own column, just like PU already could',
            de: '<strong>AFG</strong> kann jetzt ebenfalls in eine eigene Spalte geschrieben werden, so wie bisher schon PU',
          },
          {
            nl: 'Kies je "Naam" als bestemming voor PU/AFG? Dan komt dat direct achter de naam van de take, bijv. <em>01-46_064-05 (AFG)</em>',
            en: 'Choose "Name" as the target for PU/AFG and it\'s added right after the take name, e.g. <em>01-46_064-05 (AFG)</em>',
            de: 'Wählst du "Name" als Ziel für PU/AFG, wird es direkt an den Take-Namen angehängt, z. B. <em>01-46_064-05 (AFG)</em>',
          },
          {
            nl: 'Bij de PU/AFG-instellingen in Voorkeuren zie je nu <strong>uitleg</strong> zodra je er met je muis op blijft staan — ook wat "Auto" precies doet',
            en: 'Hover over the PU/AFG settings in Preferences and you now get a short <strong>explanation</strong> — including what "Auto" actually does',
            de: 'Wenn du bei den PU/AFG-Einstellungen in den Einstellungen mit der Maus verweilst, siehst du jetzt eine <strong>Erklärung</strong> — auch, was "Auto" genau macht',
          },
          {
            nl: '<strong>Strakkere, rustigere uitstraling</strong> van het programma',
            en: '<strong>A tighter, calmer look</strong> for the app',
            de: '<strong>Schlankeres, ruhigeres Erscheinungsbild</strong> der App',
          },
        ],
      },
      {
        ...
        items: [
          {
            nl: 'Bij bepaalde rapporten werd de <strong>AF-kolom</strong> (afgebroken take) niet gelezen — dat is nu opgelost',
            en: 'For certain reports, the <strong>AF column</strong> (aborted take) wasn\'t being read — this is now fixed',
            de: 'Bei bestimmten Berichten wurde die <strong>AF-Spalte</strong> (abgebrochener Take) nicht gelesen — das ist jetzt behoben',
          },
          {
            nl: 'Bij sommige rapporten met een liggend streepje (<em>_</em>) tussen scene en slate (bijv. <em>02-34_048-03</em>) ging de herkenning mis — dit werkt nu ook goed',
            en: 'For some reports with an underscore (<em>_</em>) between scene and slate (e.g. <em>02-34_048-03</em>), recognition failed — this now works correctly too',
            de: 'Bei manchen Berichten mit einem Unterstrich (<em>_</em>) zwischen Szene und Slate (z. B. <em>02-34_048-03</em>) schlug die Erkennung fehl — das funktioniert jetzt ebenfalls korrekt',
          },
          {
            nl: 'In één specifiek rapportformaat werden notities na slate 16 soms niet meegenomen — verholpen',
            en: 'In one specific report format, notes after slate 16 were sometimes missed — fixed',
            de: 'In einem bestimmten Berichtsformat wurden Notizen nach Slate 16 manchmal nicht übernommen — behoben',
          },
          {
            nl: 'Op Annuleren klikken bij het kiezen van een kolom liet soms per ongeluk een verkeerde kolomnaam achter — dat gebeurt nu niet meer',
            en: 'Clicking Cancel while choosing a column could accidentally leave behind the wrong column name — this no longer happens',
            de: 'Ein Klick auf Abbrechen bei der Spaltenauswahl konnte versehentlich einen falschen Spaltennamen hinterlassen — das passiert jetzt nicht mehr',
          },
          {
            nl: 'Een paar situaties waarin het programma per ongeluk crashte (o.a. een zwart scherm bij opstarten) zijn verholpen',
            en: 'A few situations where the app could crash unexpectedly (including a black screen on startup) have been fixed',
            de: 'Ein paar Situationen, in denen die App unerwartet abstürzte (u. a. ein schwarzer Bildschirm beim Start), wurden behoben',
          },
        ],
      },
    ],
