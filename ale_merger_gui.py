            ...
            for pdf_p in self.pdf_paths:
                ...
                if clips is None:
                    ...
                    def _show_mapper(p=pdf_p, rh=result_holder, ev=done_event):
                        self._show_layout_mapper(p, lambda mapped: (rh.__setitem__(0, mapped), ev.set()))
